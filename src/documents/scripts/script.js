(function(){
  ...
  function setFeaturedWorkBackground(){
    var featuredWorkBackground = Trianglify({
      height: document.getElementsByClassName('content-section--trianglify')[0].offsetHeight,
      width: document.getElementsByClassName('content-section--trianglify')[0].offsetWidth,
      cell_size: 100,
      x_colors: ['#7a1631', '#3f0b1b', '#7a1631'],
      y_colors: ['#fc7d49', '#3f0b1b', '#7a1631'],
    });

    $('.content-section--trianglify').each(function() {
  ...
  function clearFeaturedWorkBackground(){
    $('.content-section--trianglify canvas').remove();
  }
